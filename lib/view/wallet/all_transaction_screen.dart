          ...
          () => Row(
            ...
            children: [
              ...
              FilterChip(
                ...
                label: Text(getLanguage().monthly,
                    style: normalText(14, Colors.white)),
                onSelected: (bool selected) {
                  if (selected) {
          ...
          children: [
                ...
                children: categoryList.map((category) {
                  return Padding(
                    ...
                    child: FilterChip(
                      ...
                      label: Text(
                        category.title ??
                            "", // Giả định category.name đã được dịch trong categoryList
                        style: normalText(14, Colors.white),
                      ),
                      onSelected: (bool selected) {
                        if (selected) {
            ...
            Padding(
              ...
              child: Obx(() {
                ...
                String locale =
                    '${localeController.currentLocale.value.languageCode}_${localeController.currentLocale.value.countryCode}';
                ...
                switch (controller.selectedFilter.value) {
                  case 'weekly':
                    ...
                    break;
                  case 'monthly':
                    dateRange = DateFormat('MMMM yyyy', locale).format(now);
                    break;
                  case 'all':
                    dateRange = getLanguage().all_transactions;
                    break;
                }
                ...
                if (transactions.isEmpty) {
                  return Row(
                    ...
                    children: [
                      ...
                      const SizedBox(width: 8),
                      Text(
                        getLanguage().no_transactions_found,
