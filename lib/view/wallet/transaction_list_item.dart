...
class TransactionListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double amountValue = (trans['amount'] is num)
        ? trans['amount'].toDouble()
        : double.tryParse(trans['amount'].toString()) ?? 0.0;
    final amount = trans['amount'].toString();
    final amountFormatted =
        '${NumberFormat.currency(symbol: '').format(amountValue)} ₫';
              ...
              child: Row(
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      isExpense ? "-$amountFormatted" : "+$amountFormatted",
                      style: TextStyle(
