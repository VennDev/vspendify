    ...
    return BottomNavigationBar(
      ...
      items: [
        BottomNavigationBarItem(
          icon: const Icon(Iconsax.home, size: 30),
          label: getLanguage()
              .title_home, // Use a function to get the localized string
        ),
        BottomNavigationBarItem(
          icon: const Icon(Iconsax.chart_square, size: 30),
          label: getLanguage()
              .title_statistics, // Use a function to get the localized string
        ),
      ],
