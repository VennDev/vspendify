    ...
    return Obx(() {
          ...
          child: Center(
            child: Column(
              children: [
                ...
                Text(getLanguage().no_transactions_in_year,
      ...
      if (categoryTotals.isEmpty) {
        return Padding(
          padding: const EdgeInsets.all(50.0),
          child: Center(
              child: Text(getLanguage().no_transactions_in_year,
                  style: mediumTextStyle(16, Colors.white))),
        );
      }
            ...
            child:
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    '${getLanguage().total}: ${NumberFormat.currency(locale: 'en_US', symbol: '₫').format(totalAmount)}',
                    style: titleText(16, Colors.white),
                  ),
                ],
              ),
              ...
              Row(
                ...
                children: [
                  if (incomeAmount > 0)
                    Text(
                      '${getLanguage().expense}: ${NumberFormat.currency(locale: 'en_US', symbol: '₫').format(incomeAmount)}',
                      style: normalText(14, Colors.green),
                    ),
                  if (expenseAmount > 0)
                    Text(
                      '${getLanguage().income}: ${NumberFormat.currency(locale: 'en_US', symbol: '₫').format(expenseAmount)}',
